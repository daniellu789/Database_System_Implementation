...
BigQ::BigQ(Pipe &in, Pipe &out, OrderMaker &sortorder, int runlength) {
        ...
        //cout<<"stage0"<<endl;
        Page p;
        priority_queue<Record *, vector<Record *> , myComp> inmemQueue(&sortorder);
        ...
        priority_queue<mergePQRec *, vector<mergePQRec *> , myCompPQ> PQ(&sortorder);
