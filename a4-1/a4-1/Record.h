...
public:
        ...
        // prints the contents of the record to the file; this requires
        // that the schema also be given so that the record can be interpreted
        void WriteToFile (Schema *mySchema, FILE *myFile);

                                                        /*** ADDED***/
           // prints the contents of the record; this requires
                // that the schema also be given so that the record can be interpreted
        void PrintRecordToFile(FILE *myFile, Record *record, Schema *mySchema);
};
